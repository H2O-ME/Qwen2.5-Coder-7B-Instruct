document.addEventListener('DOMContentLoaded', function() {
    ...
    newChatButton.addEventListener('click', function() {
        chatContainer.innerHTML = `
            <div class="welcome-message">
                <h2>欢迎使用清言AI</h2>
                <p>这是一个基于Qwen/Qwen2.5-Coder-7B-Instruct模型的AI聊天应用，请输入您的问题开始对话。</p>
    ...
    function sendMessage() {
        ...
        // 调用Qwen/Qwen2.5-Coder-7B-Instruct API
        fetchChatResponse(message, botMessageElement);
    }
    
    // 调用硅基流动的Qwen/Qwen2.5-Coder-7B-Instruct API
    ...
    blueThemeStyles.textContent = `
        ...
        body.dark-theme .welcome-message h2::after {
